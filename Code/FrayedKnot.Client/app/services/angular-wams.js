...
angular.module('wams.module', [])
  .service('wams', function wams($q) {

    var API_URL = 'https://frayedknot.azure-mobile.net/';
    var API_KEY = 'FovMOPaZTJbHPGIFpIzXQRbgmYGAKP50';
    ...
    return{
        ...
        */
        query: function(tableName, obj, withFilterFn){
            ...
            if (isNullOrUndefined(tableName)){
                console.error('wams.query: You must specify a table name');
                return null;
            }
        ...
        getById: function (tableName, id, withFilterFn) {
            if (isNullOrUndefined(tableName)) {
                console.error('wams.getById: You must specify a table name');
                return null;
            }

            if (isNullOrUndefined(id)) {
                console.error('wams.getById: You must specify the id');
                return null;
            }
        ...
        */
        ...
        insert: function(tableName, obj, withFilterFn){
            if (isNullOrUndefined(tableName)){
                console.error('wams.insert: You must specify a table name');
                return null;
            }

            if (isUndefinedOrNotAnObject(obj)){
                console.error('wams.insert: You must specify the insert object');
                return null;
            }
        ...
        */
        ...
        update: function(tableName, obj, withFilterFn){
            if (isNullOrUndefined(tableName)){
                console.error('wams.update: You must specify a table name');
                return null;
            }

            if (isUndefinedOrNotAnObject(obj)){
                console.error('wams.update: You must specify the insert object');
                return null;
            }
        ...
        */
        ...
        del: function(tableName, obj, withFilterFn){
            if (isNullOrUndefined(tableName)){
                console.error('wams.del: You must specify a table name');
                return null;
            }

            if (isUndefinedOrNotAnObject(obj)){
                console.error('wams.del: You must specify the insert object');
                return null;
            }
        ...
        */
        ...
        login: function(oauthProvider){
            ...
            if (!angular.isDefined(oauthProvider) || VAILD_OAUTH_PROVIDERS.indexOf(oauthProvider) === -1){
                throw new Error('wams.login Invalid or no oauth provider listed.');
            }
        ...
        */
        ...
        invokeApi: function(name, options){
            ...
            if (isNullOrUndefined(name)){
                console.error('wams.invokeApi No custom api name specified');
                return null;
            }
            ...
            if (isUndefinedOrNotAnObject(options)){
                ...
                console.error('wams.invokeApi Invalid method type');
                return null;
            }
